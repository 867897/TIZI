...
MIRROR_OWNER="867897"
MIRROR_REPO="TIZI"
MIRROR_REF="main"          # 强烈建议改成具体 commit hash（git rev-parse main）以锁版本
...
SELF_UPDATE_URL="${RAW_BASE}/ssr.sh"   # 如果你以后把改好的 ssr.sh 也放进同一仓库，自更新会走这里

# 可选：为关键下载提供 SHA-256 校验。强烈建议在你本地算一次后填进来。
# 算法： curl -fSL <URL> | sha256sum    把第一段 hash 粘到这里
SSR_SRC_SHA256="e1fa40ab977094a724f853b71f5739028e2ee3a8f7bbf85700f50066737253df"
SSR_INIT_CENTOS_SHA256="090414f2e91355467f6c30ce5109c844265efa29c8920dc04efdebf53ac3d7d7"
SSR_INIT_DEBIAN_SHA256="76be8a16f98ff4030795f00ebb115e9239cc7e711e7cc10497f86e3c36f65bfa"
